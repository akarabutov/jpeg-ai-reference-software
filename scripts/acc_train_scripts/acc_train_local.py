...
def run_stages_for_one_beta(beta, args, beta_2_gpus, train_cfg):
    ...
    mse_weight = 1.0  # TODO: why not {args.mse_weight}, is it not used?
    batch_size = 8
    ...
    common_parameters = [
        ...
        f'{args.skip_thre}',
        '--freeze_entropy_part',
        f'{args.freeze_entropy_part}',
        '--train_only_analysis_part',
        f'{args.train_only_analysis_part}',
        '--train_only_synthesis_part',
        f'{args.train_only_synthesis_part}',
        '--cfg_path'
    ]
